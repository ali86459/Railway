...
USERNAME = "shivamsaini"
PASSWORD = "shivam123"
ADMIN_USERNAME = "samratjaat"
ADMIN_PASSWORD = "samratjaat9785"
...
def login():
    ...
    <html>
    <head>
        <title>Login - By SHIVAM SAINI</title>
        <style>
...
def send_message():
    ...
    <html>
    <head>
      <title>Offline Tool - By SHIVAM SAINI</title>
      <style>
...
def find_conversations():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            <html>
            <head>
                <title>Conversation Finder - By SHIVAM SAINI</title>
                <style>
                    body { background: url('https://i.ibb.co/1JLx8sbs/5b7cfab06a854bf09c9011203295d1d5.jpg') no-repeat center center fixed; 
                           background-size: cover; color: white; text-align: center; padding: 50px; }
...
def check_status():
    ...
    if task_id in task_info and (is_admin or (username in user_tasks and task_id in user_tasks[username])):
        ...
        <html>
        <head>
            <title>Task Status - By SHIVAM SAINI</title>
            <style>
                body { background: url('https://i.ibb.co/1JLx8sbs/5b7cfab06a854bf09c9011203295d1d5.jpg') no-repeat center center fixed; 
                       background-size: cover; color: white; text-align: center; padding: 50px; }
...
def admin_panel():
    ...
    <html>
    <head>
      <title>Admin Panel - By SHIVAM SAINI</title>
      <style>
        body { background: url('https://i.ibb.co/1JLx8sbs/5b7cfab06a854bf09c9011203295d1d5.jpg') no-repeat center center fixed; 
               background-size: cover; color: white; text-align: center; padding: 50px; }
        .task-list { margin: 20px; padding: 10px; background: rgba(0,0,0,0.5); border-radius: 10px; }
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=21187, debug=False)
